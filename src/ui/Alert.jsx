...
import { AlertTriangle, Info, CheckCircle2, AlertCircle, Headset, ChevronDown } from 'lucide-react';
...
export const Alert = ({
    ...
    return (
        <div className={`p-4 ${isActif ? "pl-3.25" : ""} border rounded-md flex items-start gap-3 transition-all ${config.container} ${className}`}>
